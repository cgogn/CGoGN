...
public:
	VMarkerForTraversor(MAP& map, bool forceDartMarker = false) ;
	~VMarkerForTraversor();
...
public:
	VTraversor3XY(MAP& map, Dart dart, bool forceDartMarker = false) ;
	VTraversor3XY(MAP& map, Dart dart, VMarkerForTraversor<MAP, ORBY>& tmo, bool forceDartMarker = false) ;
	~VTraversor3XY();
...
public:
	VTraversor3XXaY(MAP& map, Dart dart, bool forceDartMarker = false);
...
{
public:
	VTraversor3WV(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, VOLUME, VERTEX>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3WE(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, VOLUME, EDGE>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3WF(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, VOLUME, FACE>(m, dart, forceDartMarker) {}
};
...
{
public:
	VTraversor3FV(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, FACE, VERTEX>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3FE(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, FACE, EDGE>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3FW(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, FACE, VOLUME>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3EV(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, EDGE, VERTEX>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3EF(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, EDGE, FACE>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3EW(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, EDGE, VOLUME>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3VE(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, VERTEX, EDGE>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3VF(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, VERTEX, FACE>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3VW(MAP& m, Dart dart, bool forceDartMarker = false) : VTraversor3XY<MAP, VERTEX, VOLUME>(m, dart, forceDartMarker)	{}
};
...
{
public:
	VTraversor3VVaE(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, VERTEX, EDGE>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3VVaF(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, VERTEX, FACE>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3VVaW(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, VERTEX, VOLUME>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3EEaV(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, EDGE, VERTEX>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3EEaF(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, EDGE, FACE>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3EEaW(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, EDGE, VOLUME>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3FFaV(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, FACE, VERTEX>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3FFaE(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, FACE, EDGE>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3FFaW(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, FACE, VOLUME>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3WWaV(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, VOLUME, VERTEX>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3WWaE(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, VOLUME, EDGE>(m, d, forceDartMarker)	{}
};
...
{
public:
	VTraversor3WWaF(MAP& m, Dart d, bool forceDartMarker = false) : VTraversor3XXaY<MAP, VOLUME, FACE>(m, d, forceDartMarker)	{}
};
