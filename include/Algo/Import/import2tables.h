...
#ifdef WITH_ASSIMP
	void extractMeshRec(AttributeContainer& container, AttributeHandler<typename PFP::VEC3, VERTEX>& positions, const struct aiScene* scene, const struct aiNode* nd, struct aiMatrix4x4* trafo);
#endif
