...
{
	std::cout << "nb vertex orbits : " << getNbOrbits<EmbeddedMap3, VERTEX>() << std::endl ;
    std::cout << "nb vertex cells : " << m_attribs[VERTEX].size() << std::endl ;

	std::cout << "nb edge orbits : " << getNbOrbits<EmbeddedMap3, EDGE>() << std::endl ;
    std::cout << "nb edge cells : " << m_attribs[EDGE].size() << std::endl ;

	std::cout << "nb face orbits : " << getNbOrbits<EmbeddedMap3, FACE>() << std::endl ;
    std::cout << "nb face cells : " << m_attribs[FACE].size() << std::endl ;

	std::cout << "nb volume orbits : " << getNbOrbits<EmbeddedMap3, VOLUME>() << std::endl ;
